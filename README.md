# catalog.forms.adapter.angular.js

[AngularJS](http://angularjs.org/) module to integrate the [catalog](https://github.com/binarta/catalog.angular.js) and [forms](https://github.com/binarta/forms.angular.js) modules based on the [Binarta](http://binarta.com/) platform.
